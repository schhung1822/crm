      ...
      <div className="flex items-center justify-between">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            ...
            <SelectItem value="past-performance">Developer</SelectItem>
            <SelectItem value="key-personnel">Admin</SelectItem>
            <SelectItem value="focus-documents">Viewer</SelectItem>
          </SelectContent>
        </Select>
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">Tất cả</TabsTrigger>
          <TabsTrigger value="past-performance">
            Developer <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            Admin <Badge variant="secondary">2</Badge>
          </TabsTrigger>
          <TabsTrigger value="focus-documents">Viewer</TabsTrigger>
        </TabsList>
